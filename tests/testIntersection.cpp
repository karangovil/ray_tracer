...
TEST_CASE("intersections should work")
{
    ...
    {
        ray<int, int> r {point(0, 0, -5), vector(0, 0, 1)};
    ...
    {
        ray<int, int> r {point(0, 1, -5), vector(0, 0, 1)};
    ...
    {
        ray<int, int> r {point(0, 2, -5), vector(0, 0, 1)};
    ...
    {
        ray<int, int> r {point(0, 0, 0), vector(0, 0, 1)};
    ...
    SECTION("ray/sphere intersections with transforms should work")
    {
        ...
        std::shared_ptr<object> s = std::make_shared<sphere>();
        dynamic_cast<sphere&>(*s).set_transform(scaling(2.0, 2.0, 2.0));
        ...
        dynamic_cast<sphere&>(*s).set_transform(translation(5.0, 0.0, 0.0));
        xs = intersect(s, r);
